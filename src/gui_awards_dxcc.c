...
void on_awards_dxcc_activate (GtkMenuItem *menuitem, gpointer user_data)
{
	if (!gtk_widget_get_visible(scorewindow))
		warningdialog (_("xlog - DXCC award"),
			_("Please enable the scoring window"), "gtk-dialog-warning");
	GtkWidget *dialog = gtk_dialog_new_with_buttons (_("xlog - DXCC award"),
	...
	/* 2 extra columns, prefix and 'all bands */
